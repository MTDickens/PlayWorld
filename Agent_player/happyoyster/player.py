...
except ImportError:  # Direct execution: python Agent_player/happyoyster/player.py
    from agent_ablation import (
        ablation_mode,
        align_action_sources,
        configured_agent,
...
OUT_ROOT = Path(os.environ.get("HAPPYOYSTER_OUT_ROOT", REPO_ROOT / "outputs" / "happyoyster"))
...
KIGRESS_BASE_URL = (os.environ.get("PLAYER_API_URL") or os.environ.get("KIGRESS_BASE_URL", "")).rstrip("/")
KIGRESS_API_KEY = os.environ.get("PLAYER_API_KEY") or os.environ.get("KIGRESS_API_KEY", "")
KIGRESS_USER_KEY = os.environ.get("PLAYER_API_KEY") or os.environ.get("KIGRESS_USER_KEY", "")
KIGRESS_MODEL = os.environ.get("PLAYER_MODEL") or os.environ.get("KIGRESS_MODEL", "claude-haiku-4-5-20251001")
...
FLAT_OUTPUTS = env_flag("HAPPYOYSTER_FLAT_OUTPUTS", False)
OUT_DIR = OUT_ROOT if FLAT_OUTPUTS else OUT_ROOT / RUN_ID
...
SPLIT_BY_PERSPECTIVE = False if FLAT_OUTPUTS else env_flag("SPLIT_BY_PERSPECTIVE", True)
