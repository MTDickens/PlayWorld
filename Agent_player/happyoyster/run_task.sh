...
OUT_ROOT_VALUE="${HAPPYOYSTER_OUT_ROOT:-${REPO_ROOT}/outputs/happyoyster}"
...
export HAPPYOYSTER_FLAT_OUTPUTS="${HAPPYOYSTER_FLAT_OUTPUTS:-1}"
export SPLIT_BY_PERSPECTIVE="${SPLIT_BY_PERSPECTIVE:-0}"
...
echo "Flat outputs: ${HAPPYOYSTER_FLAT_OUTPUTS}"
