...
def configured_agent():
    ...
    if provider == "claude":
        ...
        if requested_transport == "anthropic":
            ...
            player_api_key = os.environ.get("PLAYER_API_KEY", "")
            headers = {
                "Content-Type": "application/json",
                "x-api-key": player_api_key or os.environ.get("KIGRESS_API_KEY", ""),
                "x-ks-user-key": player_api_key or os.environ.get("KIGRESS_USER_KEY", ""),
