...
WORLDPLAY_DIR="${GENIE3_DATA_ROOT:-${REPO_ROOT}/data}"
...
OUT_ROOT_VALUE="${GENIE3_OUT_ROOT:-${REPO_ROOT}/outputs/genie3}"
...
export GENIE3_DATA_FILES="${GENIE3_DATA_FILES:-GC:gc/data.json}"
...
"${PYTHON_BIN}" "${SCRIPT_DIR}/player.py" 2>&1 | tee "$LOG_PATH"
