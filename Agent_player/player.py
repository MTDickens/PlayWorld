...
class NewModelPlayer(Player):
    """Copy/rename this class and implement the model-specific hooks."""

    model_name = "new_model"

    def select_page(self, context: BrowserContext) -> Page:
        raise NotImplementedError("Implement page selection for the signed-in model page")

    def create_world(self, task: PlayerTask, output_dir: Path) -> None:
        raise NotImplementedError("Implement initial-frame upload and objective submission")

    def wait_until_ready(self, task: PlayerTask, output_dir: Path) -> None:
        raise NotImplementedError("Implement readiness detection for the interactive world canvas")


if __name__ == "__main__":
    raise SystemExit(
        "player.py is the base adapter template. Copy Agent_player/your-models "
        "for another model, or run a concrete model's player.py."
    )
